...
import { categoryController, productController } from "../controllers/category.controller";
 ...
 */
router.post('/', validateBody(createCategoryValidationSchema), productController.createProduct);
