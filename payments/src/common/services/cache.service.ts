...
export class CacheService {
    ...
    /**
     * Generate standardized payment cache key
     */
    ...
    /**
     * Generate standardized payment method cache key
     */
    generatePaymentMethodKey(userId: string): string {
        return `payment_methods:${userId}`;
    }

    /**
     * Generate standardized transaction cache key
     */
    ...
    /**
     * Generate standardized payment history cache key
     */
    generatePaymentHistoryKey(userId: string, page: number = 1, limit: number = 10): string {
        return `payment_history:${userId}:${page}:${limit}`;
    }
}
